...
def main():
    ...
    current_stage = -1
    sub_train_loader, candidate_index = selectLoader(train_data, model, parameters.num_initial, "random", parameters.batch_size, candidate_index, class_num=parameters.class_num, dataName='mnist', epsilon=None)
    # Training
    best_acc = 0

...
def get_args():
    ...
    parser.add_argument('--dataName', default='svhn', type=str, choices=['mnist', 'svhn', 'fashion','cifar10'])
    parser.add_argument('--metric', default="random", type=str, choices=["random", "bald", "dfal", "entropy", "gini", "entropyDrop", "lc", "margin", "mcp", "egl", "kcenter", "dre","kcenterOpt"], help="name of acquisition functions")
